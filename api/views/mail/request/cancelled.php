    ...
    <tr>
        <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.06);">
                <tr>
                    <td style="background:#c62828; color:#fff; padding:24px 30px; text-align:center;">
                        <h1 style="margin:0; font-size:22px;">Заявка №<?= $model->id ?> отменена</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:30px;">
                        ...
                        <p style="font-size:16px; line-height:1.6;">
                            К сожалению, ваша заявка <strong>№<?= $model->id ?></strong> была отменена.
                        </p>
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0" style="margin:20px 0; border:1px solid #e0e0e0; border-radius:6px;">
                            ...
                            <tr>
                                ...
                                <td style="color:#c62828; font-weight:bold;">Отменена</td>
                            </tr>
                            <?php if (!empty($model->admin_notes)): ?>
                            <tr>
                                <td style="background:#f9f9f9; font-weight:bold;">Причина</td>
                                <td><?= nl2br(htmlspecialchars($model->admin_notes)) ?></td>
                            </tr>
                            <?php endif; ?>
                        </table>

                        <p style="font-size:16px; line-height:1.6;">
                            Если у вас остались вопросы или вы хотите оформить повторный заказ, свяжитесь с нами:<br>
                            📞 <a href="tel:<?= preg_replace('/[^+\d]/', '', $phone) ?>" style="color:#c62828; text-decoration:none;"><?= $phone ?></a>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="background:#f4f6f8; padding:16px 30px; text-align:center; font-size:12px; color:#888;">
                        ...
                        <a href="<?= $siteUrl ?>" style="color:#c62828; text-decoration:none;"><?= $siteUrl ?></a>
                    </td>
                </tr>
            </table>
        </td>
